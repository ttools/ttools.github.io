...
For the product manager this means shifting focus from taking requirements and writing specs to discovering what the customer's problems are. Cagan advocates a parallel process where continuous discovery and continuous delivery processes run side-by-side. 

Discovery should focus on validating the key risks:
